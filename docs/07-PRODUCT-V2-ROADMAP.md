...
Vendors may declare multiple chain/token routes with priority and verification
state; only a selected, policy-allowed, explicitly verified route can execute.
