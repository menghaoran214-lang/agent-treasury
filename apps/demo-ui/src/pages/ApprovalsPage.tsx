...
export default function ApprovalsPage({ onOpenApproval }: { onOpenApproval: (request: ApprovalRequest) => void }) {
  ...
  return <div className="operations-page">
    <div className="page-heading"><div><span className="page-index">02.</span><h1>{t('v2.approvals.title')}</h1><p>{t('v2.approvals.subtitle')}</p></div><span className="badge badge-yellow">{t('v2.approvals.pending')}</span></div>
